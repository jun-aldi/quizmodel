                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?=$date = $item['created_at']?></span>
                      </td>
                      <td class="align-middle">
                        <a href="<?= base_url('/dashboard/profile/' . $item['username'])?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Detail
                        </a>
                      </td>
                    </tr>
