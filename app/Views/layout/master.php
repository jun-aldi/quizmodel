...
<body>
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
            <a class="nav-link <?= ($page == 'about' ? 'active' : '')?>" href="<?php echo base_url('about')?>">About</a>
            </li>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('dashboard'); ?>" tabindex="-1">Dashboard</a>
            </li>
        </ul>
        </div>
    </div>
...
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2022 Copyright:
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">Juniar</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
